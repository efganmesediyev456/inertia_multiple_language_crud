                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote_az" name="title" class="form-control" v-model="form.content.az"></textarea>
                                </div>
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote_en" name="content" class="form-control" v-model="form.content.en"></textarea>
                                </div>
                        ...
                        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote_ru" name="content" class="form-control" v-model="form.content.ru"></textarea>
                                </div>
